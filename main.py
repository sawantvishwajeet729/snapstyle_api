...
def image_generation(image_bytes: bytes, style: str) -> (bytes, dict):
    ...
    prompt = (
        ...
        "2.  **Outfit Design**: Design a complete outfit that fits the specified style, ensuring that:\n"
        ...
        "3.  **Text Description**: Provide a detailed, search-friendly JSON description of the *new* outfit you just created.\n\n"
    ...
    try:
        ...
        # FIXED: Use the correct SDK initialization matching your working code
        from google import genai as genai_client
        client = genai_client.Client(api_key=get_settings().GOOGLE_API_KEY)
        
        # FIXED: Use the correct model name and API call
        response = client.models.generate_content(
            model="gemini-2.5-flash-image",  # Use the working model
        ...
        if generated_image_pil:
            ...
            print("No image was generated by the model.")
